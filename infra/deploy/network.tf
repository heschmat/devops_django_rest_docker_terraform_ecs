...
###########################################################
# Public Subnet for public access to load balancer        #
###########################################################
...
resource "aws_route_table" "publi_a" {
  vpc_id = aws_vpc.main.id
...
resource "aws_route_table_association" "public_a" {
  ...
  route_table_id = aws_route_table.publi_a.id
}
...
resource "aws_route_table" "publi_b" {
  vpc_id = aws_vpc.main.id
...
resource "aws_route_table_association" "public_b" {
  ...
  route_table_id = aws_route_table.publi_b.id
}
...
############################################################
# Endpoints to give ECS access to aws resources            #
# e.g., ECR, CloudWatch & Systems Manager                  #
############################################################
...
resource "aws_vpc_endpoint" "ecr" {
  vpc_id = aws_vpc.main.id
  # the name of the service that this endpoint connects to:
